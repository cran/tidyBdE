...
#>               <dbl> <chr>                                                             
#> 1            573214 Tipo de cambio. Libras esterlinas por euro (GBP/EUR).Datos diarios
```
...
<img src="./chart-1.png" title="plot of chunk chart" alt="plot of chunk chart" width="100%" height="60%" />
...
<img src="./macroseries-1.png" title="plot of chunk macroseries" alt="plot of chunk macroseries" width="100%" height="60%" />
...
<img src="./gdp-1.png" title="plot of chunk gdp" alt="plot of chunk gdp" width="100%" height="60%" />
